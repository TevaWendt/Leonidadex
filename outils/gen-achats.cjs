...
const cards = [
  ...
  { label: 'Collectibles', href: 'collectibles.html', status: 'pending', n: null, unit: '', text: 'Le suivi est prêt ; aucun objet à collectionner n’est actuellement publié dans le catalogue. Cette section ne constitue pas une catégorie d’achat confirmée.' }
];
