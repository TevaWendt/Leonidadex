...
const cards = [
  ...
  { label: 'Bateaux', href: 'bateaux.html', status: count(acq, 'boats') ? 'shown' : 'pending', n: count(acq, 'boats'), unit: 'documentés', text: 'Les embarcations dont Rockstar décrit l’obtention (Édition Ultimate), reliées aux fiches Véhicules.' },
