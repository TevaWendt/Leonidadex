...
Mis à jour le 26 septembre 2026 · livraison **v7.38 = lot 1 « Calibrage »** (premier des dix lots issus des retours du 26 septembre), sur la v7.37 (audit final + référencement), elle-même sur la v7.36 (lots A + B + C + calculateur « puissant » + business plan + ergonomie + Motion+). La refonte en trois lots est complète ; l’audit v7.29 ci-dessous reste valable.

## Refonte en trois lots (25/09/2026)

| Lot | État | Contenu |
|---|---|---|
| Lot 1 — Calibrage | **Livré (v7.38)** | Pastilles du Tuto centrées, section repliée du calculateur en carte, page Progression refaite (8 cartes alignées, listes dépliables garage / arsenal / équipements / munitions / collectibles, ancres), liens « Voir mon garage / mon arsenal », suivi générique par famille (suivi.js : équipements et munitions cochables, export / import, compteur global), boutons alignés en bas des cartes (13 grilles), piles d’images cliquables (62 liens). 377 tests, 278 tests navigateur, verifier 0 erreur. Suite : lots 2 à 10 (prompts dans le doc « Prompts des lots »). Détail : outils/CHANGEMENTS-v7.38.txt |
...
| Ergonomie du calculateur | **Livré (v7.35)** | Tout ce qui n’est pas la réponse est rangé dans des points repliables avec l’essentiel dans le titre (document du plan, huit calculs, Expert), contenu calculé à l’ouverture, état gardé, tout déplier / replier, ouverture à l’impression. Mouvement sobre (réponse, cartes, frise, boutons, réduction des animations respectée). Graphiques refaits (aire dégradée, info-bulles, axes lisibles, légende en pastilles) avec points modifiables (partie réelle, chiffre de sensibilité). 6 tests dédiés. Détail : outils/CHANGEMENTS-v7.35.txt |
| Business plan mission par mission | **Livré (v7.34)** | Le plan a ses propres réponses (rien pris en silence dans les huit calculs), programme partie par partie (« en premier, en deuxième… »), buts achat / somme / déblocage par l’expérience, plans de secours A/B/C toujours présents, mise à jour qui recalcule tout (missions faites, achats, points, bilan prévu / réel), deux carnets séparés avec fiche complète imprimable, rapport en document lisible. 15 tests dédiés. Détail : outils/CHANGEMENTS-v7.34.txt |
| Calculateur (prompt Astra) | **Livré (v7.33)** | Moteur : avec/sans achat sur le même horizon, coût d’opportunité, stratégies de plan, échéance, prochaine partie, courbe prévu/réel. Business plan exécutable (point de départ, stratégie conseillée, étapes chiffrées, prochaine partie, suivi du réel sans double compte, échéance, seuils, export texte). « Ça vaut le coup ? » en trois cas. Bloc de réponse commun (conclusion, chiffres, prochaine action, compromis, hypothèses, manques). Erreur → case. Pas à pas explicatif et adaptatif. Graphiques avec titre, axes, légende, lecture, tableau. Léo, Tuto, barre de question alignés. 352 tests. Détail : outils/CHANGEMENTS-v7.33.txt |
